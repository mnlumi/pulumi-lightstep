...
import (
	...
	"github.com/mnlumi/pulumi-lightstep/provider/pkg/version"
...
const (
	...
	mainPkg = "lightstep"
	// modules:
	mainMod = "index" // the lightstep module
)
...
func Provider() tfbridge.ProviderInfo {
	...
	p := shimv2.NewProvider(lightstep.Provider())
	...
	prov := tfbridge.ProviderInfo{
		...
		PluginDownloadURL: "",
		Description:       "A Pulumi package for creating and managing lightstep cloud resources.",
		// category/cloud tag helps with categorizing the package in the Pulumi Registry.
		// For all available categories, see `Keywords` in
		// https://www.pulumi.com/docs/guides/pulumi-packages/schema/#package.
		Keywords:   []string{"pulumi", "lightstep", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/mnlumi/pulumi-lightstep",
