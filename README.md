...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `lightstep` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-lightstep
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/mnlumi/pulumi-lightstep/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-lightstep/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-lightstep_darwin_amd64_v1
│   └── pulumi-resource-lightstep
├── pulumi-lightstep_darwin_arm64
│   └── pulumi-resource-lightstep
├── pulumi-lightstep_linux_amd64_v1
│   └── pulumi-resource-lightstep
├── pulumi-lightstep_linux_arm64
│   └── pulumi-resource-lightstep
├── pulumi-lightstep_windows_amd64_v1
│   └── pulumi-resource-lightstep.exe
└── pulumi-lightstep_windows_arm64
    └── pulumi-resource-lightstep.exe
```
